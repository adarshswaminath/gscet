      ...
      <section>
        <div className="grid min-h-screen px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-12 md:text-5xl xl:text-6xl">
              College Coding Kickstart <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-indigo-900">Hackathon</span>
            </h1>
